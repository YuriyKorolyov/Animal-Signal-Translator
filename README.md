...
AI использован для проектирования прототипа (Codex), формулировки правил, структуры базы знаний, интерфейса и README. Внешние AI API в рантайме не используются: приложение работает локально и детерминированно.
